...
description: "An orientation lesson introducing full stack engineering, course prerequisites, and what to expect from this program."
tags: [orientation, full-stack, introduction, prerequisites]
draft: false
date: "2026-01-30"
---
...
Welcome! You're about to embark on a journey to become a **full stack engineer**. This orientation will help you understand what that means, what you'll need to succeed, and what lies ahead in this course.
...
Each lesson in this course follows a consistent structure to help you learn effectively:

- **Lecture** - Found in the `lecture/` folder, these materials introduce concepts and explain the "why" behind what you're learning
- **Exercise** - Found in the `exercise/` folder, these hands-on activities let you practice what you've learned
- **Lab** - Found in the `lab/` folder, these assignments help you apply your knowledge to real scenarios

This structure allows you to learn at your own pace: read the lecture materials, practice with exercises, and demonstrate your understanding through labs.
...
- **Self-Paced Learning**: Work through lectures, exercises, and labs when it fits your schedule
...
- **Lectures** - Found in the `lecture/` folder of each lesson
- **Exercises** - Found in the `exercise/` folder of each lesson  
