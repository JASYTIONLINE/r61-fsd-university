...
**Previous Exercise:** [[s2-version-control/s2e1-authenticating-git-with-github|Exercise 1: Authenticating Git with GitHub]]

**Next Exercise:** [[s2-version-control/s2e3-pushing-changes|Exercise 3: Pushing Changes]]
